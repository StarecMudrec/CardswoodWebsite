...
class Config:
    ...
    # Формула подписи: v1=ID+TRANSACTION_ID+AMOUNT+CURRENCY+key; v2=ID+AMOUNT+TRANSACTION_ID+key; v3=как v2, сумма целым; v4=ID+TRANSACTION_ID+key (без суммы)
    PAYANYWAY_SIGNATURE_VERSION = os.getenv("PAYANYWAY_SIGNATURE_VERSION", "v4").strip().lower()
