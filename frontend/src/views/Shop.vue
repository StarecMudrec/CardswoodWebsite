    ...
    return {
      products: [
        ...
        },
        {
          id: 7,
          name: 'ТЕСТОВЫЙ ТОВАР',
          description: 'Тестовый товар для проверки функционала. Стоимость: 1₽.',
          price: 1,
        ...
        },
        {
          id: 8,
          name: 'КАРЬЕРА УЧЕБА',
          description: 'Данный уровень открывает возможность новой ветки квестов в карьере, среди его наград:\n\n- ВОЗМОЖНОСТЬ ПОЛУЧИТЬ 3 СПЕШЛ КАРТЫ\n- ВОЗМОЖНОСТЬ ВЫБРАТЬ ПЕРСОНАЖА СЛЕДУЮЩЕГО СЕЗОНА\n- УВЕЛИЧИТЬ ШАНСЫ НА ОСОБЫЕ КАРТЫ\n- ACHIEVEMENT КАРТА ЗА ПРОХОЖДЕНИЕ ВСЕЙ КАРЬЕРЫ\n- ТАКЖЕ УВЕЛИЧЕННЫЕ НАГРАДЫ ПО СРАВНЕНИЮ С РАБОТОЙ\n\nДанный уровень будет открыт до конца сезона!',
          price: 149,
          image: '/School.jpg',
          tag: 'Новый'
        },
        {
          id: 9,
          name: 'КАРЬЕРА БИЗНЕС',
          description: 'Данный уровень открывает возможность новой ветки квестов в карьере, среди его наград:\n\n- НАЕМ РАБОТНИКОВ (ПОСЛЕ ТОГО КАК ТЫ ПОЛУЧАЕШЬ НАГРАДУ, МОЖЕШЬ ВВЕСТИ ТЕГ БУДУЩЕГО РАБОТНИКА, МЕНЯТЬ РАБОВ НЕЛЬЗЯ БЕЗ ИХ СОГЛАСИЯ, ПОЛУЧАЕШЬ 25% ОТ ИХ НАГРАД, НЕ СЧИТАЯ ОСОБЫХ НАГРАД)\n- ТЕБЯ НЕ МОГУТ НАНЯТЬ\n- ACHIEVEMENTS КАРТА ЗА ПРОХОЖДЕНИЕ ВСЕЙ КАРЬЕРЫ\n- ВОЗМОЖНОСТЬ ВЫБРАТЬ ПЕРСОНАЖА СЛЕДУЮЩЕГО СЕЗОНА\n- ЕЩЕ БОЛЬШИЕ НАГРАДЫ ПО СРАВНЕНИЮ С ДРУГИМИ УРОВНЯМИ КАРЬЕРЫ\n\nДанный уровень будет открыт до конца сезона!',
          price: 149,
          image: '/Business.jpg',
          tag: 'Новый'
        }
